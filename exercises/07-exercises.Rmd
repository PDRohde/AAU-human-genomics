...
Note, if you have troubles computing LD, you can download the ld and updated Glist below.
```{r,  eval=FALSE, echo=TRUE}
url <- "https://github.com/PDRohde/AAU-human-genomics/raw/main/exercises/human.ld"
download.file( url=url, destfile="human.ld")
url <- "https://github.com/PDRohde/AAU-human-genomics/raw/main/exercises/Glist_sparseLD_1k.RDS"
